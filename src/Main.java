public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Автор - " + hello.getAuthor().getFirstName() + " " + author.getLastName());
        ...
        Book hello1 = new Book("как делишки?", author, 2016);
        System.out.println("Заголовок - " + hello1.getTitle());
        System.out.println("Автор - " + hello1.getAuthor().getFirstName() + " " + author.getLastName());
